...
{
    public class Sys_account_roleData : BaseData
    {
        /// <summary>
        /// 對應的Model型別
        /// </summary>
        private Type _modelType = typeof(Sys_account_roleInfo);
        ...
        /// <param name="p"></param>
        /// <returns></returns>
        public int DeleteDataByAct(IDbTransaction trans, string act_id)
        {
            string sql = @"
                delete sys_account_role
                where act_id = @act_id";

            var obj = Db.ExecuteNonQuery(trans, sql, Db.GetParam("@act_id", act_id));
