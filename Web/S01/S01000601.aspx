                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="單位數" SortExpression="Sys_uid_count">
                        <ItemTemplate>
                            ...
                            <asp:Button ID="setRoleUnit_btn" runat="server" CommandArgument='<%# BindItem.Sys_rid %>' CssClass="btnGrv set" Text="設定單位" ToolTip="設定單位" OnClick="setRoleUnit_btn_Click" UseSubmitBehavior="False" />
                        </ItemTemplate>
                        <HeaderStyle Width="30px" Wrap="False"  />
