...
<asp:Content ID="Content2" ContentPlaceHolderID="baseContent_cph" runat="server">
    ...
    <span style="position: relative;margin-left: 10px;">
        <i class="fa fa-download btn btn-success btn-lg" aria-hidden="true"><label>下載</label></i>
        <asp:Button ID="download_btn" runat="server" class="movedown" Text="下載" ToolTip="下載" UseSubmitBehavior="False" OnClick="download_btn_Click"/>
    </span>
    <br />
    <br />
            ...
            <div class="popupWindowContent">
                <asp:Panel ID="Panel2" runat="server">
                    <asp:HiddenField ID="email_hf" runat="server" />
                     <asp:HiddenField ID="gv_idn_hf" runat="server" />
                    <table id="pwd_tb" class="table">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox TextMode="Password" ID="password_txt" runat="server" minlength="6"></asp:TextBox><br />
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <asp:TextBox TextMode="Password" ID="passwordcheck_txt" runat="server" minlength="6"></asp:TextBox><br />
                            </td>
                        </tr>
                        <tr>
                            <th></th>
