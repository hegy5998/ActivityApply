...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent_cph" runat="server">
    <asp:Panel ID="form_panel" runat="server" Visible="true">
        <asp:UpdatePanel runat="server" ID="UpdatePanel3">
            <ContentTemplate>
                <!-- 如果沒有開啟JavaScript則會請使用者開啟才能使用本網頁的功能 START -->
                <noscript>
                ...
                <div class="row">
                    ...
                    <div role="tabpanel">
                        ...
                        <ul class="nav nav-tabs nav-justified" role="tablist">
                            ...
                            <li role="presentation"><a href="#activityQus" aria-controls="SignUp" role="tab" data-toggle="tab">修改報名表</a></li>
                        </ul>
                        <br />
                        <!-- 頁籤標題 END -->
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 dexc">
                                        ...
                                        <script type="text/javascript">
                                            $(document).ready(function() {
                                                $.ajax({
                                                    url: '/S02/S02010103.aspx?sys_id=S01&sys_pid=S02010103',
                                                    type: 'GET',
                                                    timeout: 12000,  //單位：毫秒。  
                                                    dataType: 'text'
                                                }).done(function (i) {
                                        ...
                                        <%--<asp:TextBox runat="server" ID="act_title" />--%>
                                        ...
                                        <div class="showback" id="delete_Session_div_1">
                                            <div class="form-horizontal style-form">
                                                ...
                                                <asp:Label runat="server" ID="aab"></asp:Label>
                            ...
                            <div class="row mt tab-pane fade" id="activityQus" role="tabpanel">
                                ...
                                <div class="row mt " id="add_Block_div">
                                    ...
                                    <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 dexc showback" id="block_div_2" >
                                        ...
                                        <div class="column form-horizontal style-form" id="add_Qus_div_2" style="min-height:50px"></div>
                                    </div>
                                    <!-- 預設區塊二_END -->
