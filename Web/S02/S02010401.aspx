...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContent_cph" runat="server">
    ...
    <asp:Label ID="caveat" runat="server" Style="color:red; font-size: large;">*請確認為信箱本人才能幫忙重設密碼</asp:Label>
                    <table class="grv" style="width: 50%;">
                        <tr class="grvDataRow">
                            <th style="width: 100px;">信箱Email</th>
                            <td>
                                <asp:TextBox runat="server" ID="email_txt" onfocus="javascript:if(this.value=='example@example.com.tw')this.value=''" Text="example@example.com.tw"  Style="width: 100%;background-color: #FEFEFE;"/>
                            </td>
                            <td rowspan="2" style="width: 100px; text-align: center;">
                                <asp:Button runat="server" ID="set_bt" Text="重設密碼" OnClick="set_bt_Click" OnClientClick="if (!confirm(&quot;確定要重設密碼?&quot;)) return false"/>
                            </td>
                        </tr>
                        <tr class="grvDataRow">
