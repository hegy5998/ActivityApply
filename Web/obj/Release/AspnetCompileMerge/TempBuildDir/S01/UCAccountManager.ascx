...
<asp:FormView ID="main_fv" runat="server"
    ...
    <InsertItemTemplate>
        ...
        <div class="opBox center">
            <asp:Button ID="add_btn" runat="server" Text="新增" CommandName="Insert" UseSubmitBehavior="false" />
            &nbsp;<asp:Button ID="cancel_btn" runat="server" Text="取消" OnClick="cancel_btn_Click" UseSubmitBehavior="false" />
        </div>
    </InsertItemTemplate>
    <EditItemTemplate>
        <table class="fv" id="accountManager">
        ...
        <div class="opBox center">
            <asp:Button ID="update_btn" runat="server" Text="儲存" CommandName="Update" UseSubmitBehavior="false" />
            &nbsp;<asp:Button ID="cancel_btn" runat="server" Text="取消" OnClick="cancel_btn_Click" UseSubmitBehavior="false" />
        </div>
    </EditItemTemplate>
</asp:FormView>
