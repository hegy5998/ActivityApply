    ...
    <div id="login">
        <div style="background-color: white; width: 413px; height: 363px; margin-left: 130px; margin-top: 50px; border-radius: 13px;">
            <div class="modal-header" style="border-radius: 13px 13px 0px 0px;text-align: center;">
                <h4 class="modal-title">報名系統登入</h4>
            </div>
            ...
            <asp:Panel ID="normal_pl" runat="server">
                ...
                <table class="fv loginContent">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="act_id_txt" CssClass="form-control" runat="server" Text="S001"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="fieldName">密碼：</td>
                        <td>
                            <asp:HiddenField ID="act_pwd_hf" runat="server" />
                            <input id="act_pwd_txt" type="password" class="form-control" style="display:inherit;"/></td>
                    </tr>
                    <tr>
                        <td class="fieldName">驗證碼：</td>
                        <td>
                            <asp:TextBox ID="confirm_txt" CssClass="form-control" runat="server" Width="50px" MaxLength="4" autocomplete="off" Style="display: inherit;"></asp:TextBox>
                            <span id="captchaBox">
