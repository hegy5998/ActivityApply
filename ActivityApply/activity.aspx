                                                ...
                                                <div class="panel-heading">相關活動</div>\
                                                    <div class="panel-body">\
                                                        ...
                                                        <div class="tooltip-demo">活動地點：' + SessionInfo[count].as_position + '\
                                                            ...
                                                            <br>\
                                                            <br>\
                                                            <a id="apply_btn_'+ count + '" href="Sign_Up.aspx?act_idn=' + SessionInfo[count].as_act + '&as_idn=' + SessionInfo[count].as_idn + '&act_class=' + $.url().param("act_class") + '&act_title=' + $.url().param("act_title") + '" class="btn btn-info" data-toggle="tooltip" data-placement="right" title="Tooltip on right">我要報名</a>\
                                                        </div>');
