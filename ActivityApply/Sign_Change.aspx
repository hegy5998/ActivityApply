<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.master" AutoEventWireup="true" CodeBehind="Sign_Change.aspx.cs" Inherits="ActivityApply.Sign_Change" %>
    ...
    <script type="text/javascript">
        ...
        function getSectionList() {
            $.ajax({
                ...
                url: 'Sign_Change.aspx/getSectionList',
        ...
        function getQuestionList() {
            $.ajax({
                ...
                url: 'Sign_Change.aspx/getQuestionList',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //成功時
                success: function (result) {
        ...
        function getApplyDetailList() {
            $.ajax({
                ...
                traditional: true,
                //傳送資料到後台為getQuestionList的function
                url: 'Sign_Change.aspx/getApplyDetailList',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //成功時
                success: function (result) {
        ...
        function SaveUserData() {
            ...
            $.ajax({
                ...
                url: 'Sign_Change.aspx/saveUserData',
